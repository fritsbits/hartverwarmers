...
class MatchInitiativeAgent implements Agent, HasStructuredOutput
{
    ...
    public function instructions(): Stringable|string
    {
        ...
        Geef voor elk initiatief een heel bondige reden (max 10 woorden, in het Nederlands) waarom het past.
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'match_reasons' => $schema->array()->items($schema->string())->required()->description('Bondige reden per match (max 10 woorden), in het Nederlands'),
        ];
    }
}
