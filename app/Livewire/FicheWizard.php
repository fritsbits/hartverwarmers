...
class FicheWizard extends Component
{
    ...
    private function getContentFields(): array
    {
        return [
            ...
            ['field' => 'aanleiding', 'label' => 'Aanleiding & verhaal', 'description' => 'Hoe groeide dit idee? Vertel over het moment, de context of de bewoner(s) die aan de basis lagen.', 'placeholder' => 'bijv. Dit idee groeide tijdens een vorming waarbij we met een bewoner over haar vroegere beroep als slager in gesprek gingen…', 'userProp' => 'aanleiding', 'aiProp' => null, 'rows' => 6, 'required' => false, 'type' => 'editor'],
