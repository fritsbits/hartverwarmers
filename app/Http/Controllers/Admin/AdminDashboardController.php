...
class AdminDashboardController extends Controller
{
    ...
    public function __invoke(): View
    {
        ...
        if (! in_array($tab, ['overzicht', 'presentatiekwaliteit', 'inhoudelijke-kwaliteit', 'onboarding', 'bedankjes', 'nieuwsbrief', 'reactivatie'], true)) {
            $tab = 'overzicht';
        }
        ...
        if ($tab === 'overzicht') {
            ...
            $initiativeSummaries = $startedInitiatives->map(fn ($i) => [
                'initiative' => $i,
                'headline' => $impact->headlineImpact($i),
            ]);
