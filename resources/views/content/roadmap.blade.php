<x-layout title="Roadmap wonen en leven">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav class="mb-6">
            <ol class="flex items-center gap-2 text-sm text-[var(--color-text-secondary)]">
                ...
                <li>/</li>
                <li class="text-[var(--color-text-primary)] font-medium">Roadmap</li>
            </ol>
        </nav>
        ...
        <div class="max-w-[48rem]">
            <h2 class="text-2xl font-bold text-[var(--color-text-primary)] mb-4">Bergbeklimming als metafoor voor jullie verandertraject</h2>
            ...
            <p class="text-sm text-center text-[var(--color-text-secondary)] mb-8">Video-overzicht van de roadmap</p>
        </div>

        <hr class="my-10 border-[var(--color-border-light)]">

        {{-- Inhoudsopgave --}}
        <p class="text-sm font-semibold text-[var(--color-text-secondary)] uppercase tracking-wide">Inhoudsopgave</p>
        <h2 class="text-2xl font-bold text-[var(--color-text-primary)] mb-6">Een gedragen woonleefbeleid in vier etappes</h2>
        ...
        {{-- Etappe 1: Visie --}}
        <div id="visie" class="bg-[var(--color-bg-subtle)] rounded-xl p-8 mb-8 scroll-mt-20">
            <div class="flex items-center gap-4 mb-6">
                <img src="/img/illustration/icon_visie.svg" alt="Visie" class="h-16 w-16">
                <div>
                    <p class="text-sm font-semibold text-amber-600 uppercase">Etappe 1</p>
                    <h2 class="text-3xl font-bold text-[var(--color-text-primary)]">Vorm visie</h2>
                </div>
            </div>
        </div>
        ...
        {{-- Etappe 2: Verzamelen --}}
        <div id="verzamelen" class="bg-[var(--color-bg-subtle)] rounded-xl p-8 mb-8 mt-12 scroll-mt-20">
            <div class="flex items-center gap-4 mb-6">
                <img src="/img/illustration/icon_verzamelen.svg" alt="Verzamelen" class="h-16 w-16">
                <div>
                    <p class="text-sm font-semibold text-blue-600 uppercase">Etappe 2</p>
                    <h2 class="text-3xl font-bold text-[var(--color-text-primary)]">Verzamel woonleefplannen</h2>
                </div>
            </div>
        </div>
        ...
        <div id="verspreiden" class="bg-[var(--color-bg-subtle)] rounded-xl p-8 mb-8 mt-12 scroll-mt-20">
            <div class="flex items-center gap-4 mb-6">
                <img src="/img/illustration/icon_verspreiden.svg" alt="Verspreiden" class="h-16 w-16">
                <div>
                    <p class="text-sm font-semibold text-red-600 uppercase">Etappe 3</p>
                    <h2 class="text-3xl font-bold text-[var(--color-text-primary)]">Verspreid leefplannen</h2>
                </div>
            </div>
        </div>
        ...
        {{-- Etappe 4: Verankeren --}}
        <div id="verankeren" class="bg-[var(--color-bg-subtle)] rounded-xl p-8 mb-8 mt-12 scroll-mt-20">
            <div class="flex items-center gap-4 mb-6">
                <img src="/img/illustration/icon_verankeren.svg" alt="Verankeren" class="h-16 w-16">
                <div>
                    <p class="text-sm font-semibold text-orange-600 uppercase">Etappe 4</p>
                    <h2 class="text-3xl font-bold text-[var(--color-text-primary)]">Veranker woonleefplannen</h2>
                </div>
            </div>
        </div>
        ...
        {{-- Outro --}}
        <div class="bg-[var(--color-bg-subtle)] rounded-xl p-8 mt-12">
            <div class="flex flex-col md:flex-row items-center gap-8">
                <div class="md:w-7/12">
                    <p class="text-sm font-semibold text-[var(--color-primary)] uppercase tracking-wide">Aanpak op maat</p>
                    <h2 class="text-2xl font-bold text-[var(--color-text-primary)] mt-1">Ieder woonzorgcentrum is uniek. Iedere roadmap dus ook.</h2>
