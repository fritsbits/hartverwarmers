    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav class="mb-6">
            <ol class="flex items-center gap-2 text-sm text-[var(--color-text-secondary)]">
                ...
                <li>/</li>
                <li><a href="{{ route('content', 'wonen-en-leven') }}" class="hover:text-[var(--color-primary)]">Wonen en leven</a></li>
                <li>/</li>
        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            {{-- Content --}}
            <div class="md:w-2/3">
                <a href="{{ route('content', ['slug' => $overviewSlug]) }}" class="text-sm font-semibold text-[var(--color-primary)] uppercase tracking-wide hover:underline">Wonen en leven in woonzorgcentra</a>
        ...
        @isset($content['expectations'])
            ...
            <div class="flex flex-col md:flex-row gap-8">
                <div class="md:w-1/3">
                    <h2 class="text-2xl font-bold text-[var(--color-text-primary)]">Wat kan je verwachten?</h2>
                </div>
                <div class="md:w-2/3">
                    @isset($content['expectations']['checklist'])
                        <div class="bg-[var(--color-bg-white)] border border-[var(--color-border-light)] rounded-lg p-5 mb-6">
        ...
        @isset($content['core-concepts'])
            ...
            <div class="flex flex-col md:flex-row gap-8">
                <div class="md:w-1/3">
                    <h2 class="text-2xl font-bold text-[var(--color-text-primary)]">Kernconcepten</h2>
                </div>
        ...
        @isset($content['more-info'])
            ...
            <div class="flex flex-col md:flex-row gap-8 pb-8">
                <div class="md:w-1/3">
                    <h2 class="text-2xl font-bold text-[var(--color-text-primary)]">Meer info</h2>
                </div>
                <div class="md:w-2/3">
        ...
        <div class="mt-8">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-[var(--color-text-primary)]">Andere woon- en leefmodellen</h2>
