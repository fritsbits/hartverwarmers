                            ...
                            @foreach ($payload->themes as $occurrence)
                                <tr>
                                    <td style="padding:14px 16px;{{ ! $loop->last ? 'border-bottom:1px solid #EBE4DE;' : '' }}">
                                        <a href="{{ \App\Support\NewsletterLink::tracked($notifiable, \App\Support\EmailLink::to(url('/themas#thema-' . $occurrence->theme->slug), 'monthly-digest', 'newsletter', 'themes')) }}" style="text-decoration:none;color:inherit;display:block">
