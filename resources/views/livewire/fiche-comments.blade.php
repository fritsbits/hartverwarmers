            ...
            <div>
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        @if($this->comments->isEmpty())
                            <p class="text-xs text-[var(--color-text-secondary)]">Wees de eerste die reageert!</p>
                        @endif
                    </div>
                </div>
                <form wire:submit="addComment">
                    <textarea
                        ...
                        rows="3"
                        class="w-full rounded-xl border border-[var(--color-border-light)] bg-[var(--color-bg-cream)] px-4 py-3 placeholder:text-[var(--color-text-secondary)]/60 focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent focus:bg-white resize-y transition-colors"
                    ></textarea>
                        ...
                        @if($replyingTo === $comment->id)
                            <div class="mt-4 pl-2 border-l-2 border-[var(--color-primary)]" x-data="{ step: {{ auth()->check() ? '2' : '1' }} }">
                                <div class="flex gap-3">
                                    ...
                                    @endauth
                                    <div class="flex-1">
                                        {{-- Step 1 (always visible): write reply --}}
                                        ...
                                        @else
                                            {{-- Guest step 1: just the submit button to advance --}}
