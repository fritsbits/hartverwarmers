            ...
            <div class="max-w-6xl mx-auto px-6 py-5">
                ...
                <div x-show="$wire.currentStep === 3" x-data="{
                    ...
                    <div
                        ...
                        x-cloak
                        role="alert"
                        class="mb-3 flex flex-wrap items-center gap-3 rounded-xl px-4 py-3 bg-[var(--color-bg-accent-light)] border border-[var(--color-border-light)]"
                    >
                        ...
                        <p class="flex-1 min-w-0 text-sm text-[var(--color-text-secondary)]">
