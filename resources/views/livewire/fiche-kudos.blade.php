    ...
    <div class="relative">
        ...
        <flux:tooltip position="bottom">
            ...
            >
                ...
                <span wire:ignore x-show="displayTotal > 0" class="font-semibold text-sm tabular-nums" style="color: var(--color-primary)" x-text="displayTotal">
                    {{ $this->totalKudos > 0 ? $this->totalKudos : '' }}
                </span>
            </button>
